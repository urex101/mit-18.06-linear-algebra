# MIT 18.06SC - Linear Algebra (Self-Study)

This is an independent self-study of MIT OpenCourseWare materials. I am not enrolled at MIT, and this repository represents no degree, credit, or certificate. All work here is my own, completed using the publicly available OCW course materials.

## About

Full self-study of 18.06SC: all 33 lectures, every problem set, and 4 exams, following the original course.

Solutions are handwritten, then graded against MIT's published official solutions. Happy to discuss any problem in detail.
...
| [Transposes, Permutations, Vector Spaces](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/ax-b-and-the-four-subspaces/transposes-permutations-vector-spaces/) | 1.5 | [✅](PSETS/Pset1.5) | 2026-07-13 |
| [Column Space and Nullspace](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/ax-b-and-the-four-subspaces/column-space-and-nullspace/) | 1.6 | [✅](PSETS/Pset1.6) | 2026-07-19 |
...
| [Orthogonal Matrices and Gram-Schmidt](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/least-squares-determinants-and-eigenvalues/orthogonal-matrices-and-gram-schmidt/) | 2.4 | ⬜ | |
| [Properties of Determinants](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/least-squares-determinants-and-eigenvalues/properties-of-determinants/) | 2.5 | ⬜ | |
| [Determinant Formulas and Cofactors](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/least-squares-determinants-and-eigenvalues/determinant-formulas-and-cofactors/) | 2.6 | ⬜ | |
| [Cramer's Rule, Inverse Matrix and Volume](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/least-squares-determinants-and-eigenvalues/cramers-rule-inverse-matrix-and-volume/) | 2.7 | ⬜ | |
| [Eigenvalues and Eigenvectors](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/least-squares-determinants-and-eigenvalues/eigenvalues-and-eigenvectors/) | 2.8 | ⬜ | |
...
| [Similar Matrices and Jordan Form](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/positive-definite-matrices-and-applications/similar-matrices-and-jordan-form/) | 3.4 | ⬜ | |
| [Singular Value Decomposition](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/pages/positive-definite-matrices-and-applications/singular-value-decomposition/) | 3.5 | ⬜ | |
...
Systems of linear equations and elimination, matrix operations and inverses, LU factorization, vector spaces and the four fundamental subspaces, orthogonality, projections and least squares, determinants, eigenvalues and eigenvectors, diagonalization, symmetric and positive definite matrices, similar matrices, and the singular value decomposition (SVD).

## Why

Building the mathematical foundation for a career in quantitative trading — linear algebra underpins regression, portfolio variance, covariance estimation, and most of the numerical methods used in the field. Studied alongside 14.01/14.02 (economics), 6.041 (probability), and CS50P (Python).

## Source

Course materials: [MIT OCW 18.06SC Linear Algebra](https://ocw.mit.edu/courses/18-06sc-linear-algebra-fall-2011/)
